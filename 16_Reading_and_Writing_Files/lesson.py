...
loaded_data_bin = np.fromfile('data.bin', dtype=int).reshape(2, 3)
...
data_with_missing = np.genfromtxt('data.txt', missing_values='NaN', filling_values=0)
...
np.save('data_lib.npy', data)
print("Data saved to 'data_lib.npy' using np.save")

loaded_data_lib = np.load('data_lib.npy')
